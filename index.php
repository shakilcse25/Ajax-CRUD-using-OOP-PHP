...
<body>
  <div class="container">
    <div class="alert alert alert-primary" role="alert">
      <h4 class="text-primary text-center">PHP MySql Ajax CRUD Using OOPS - Pagination</h4>
    </div>
...
?>
    <div class="row mb-3">
      <div class="col-7">
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#userModal" id="addnewbtn">Add Profile <i
...
<?php
include_once 'profilestable.php';
?>
    <nav id="pagination">
    </nav>
